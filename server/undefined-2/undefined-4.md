...
* 일부 가구 상호작용을 지원합니다. (앉기, 쓰레기통, 조합, 빛발산 등)\


{% hint style="info" %}
**각각의 가구 획득 경로 안내**

* **빨강, 하양, 청록, 회색, 조경가구 -> 필드조합으로 획득 가능 (/ia 명령어 사용)**
* **조경가구 2 -> 작물 교환권으로 획득 가능**
* **자수정, 모던 -> 서버 돈으로 획득 가능**&#x20;
* **철, 모던 -> 추천코인으로 획득 가능**
{% endhint %}

<figure><img src="../../.gitbook/assets/image (5) (3).png" alt=""><figcaption><p>필드 조합으로 획득(빨강, 하양, 청록, 회색, 조경)</p></figcaption></figure>
