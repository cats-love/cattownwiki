...
* <mark style="color:green;">**밴 기간이 지난 이후에도 밴이 풀리지 않으면, 해명하기 게시판으로 문의**</mark>해주시길 바라며, \
  <mark style="color:red;">**밴 해제에 관한 과도한 재촉 시 처벌 기간이 1일 씩 늘어날 수 있습니다.**</mark>
{% endhint %}

{% hint style="info" %}
* 경고 3회를 받으면 7일 밴 처리됩니다.
* 경고 4회를 받으면 14일 밴 처리됩니다.
* 경고 5회를 받으면 30일 밴 처리됩니다.
* 5회 이상 : 1회 해명게시판 해명 후 추가 경고 획득시 영구밴 처리됩니다
{% endhint %}
